...
Step.delete_all
Step.create( {:title => 'Book 1 Step 1', :description => 'Description of book 1 step 1', :book_id => book1.id })
Step.create( {:title => 'Book 1 Step 2', :description => 'Description of book 1 step 2', :book_id => book1.id })
