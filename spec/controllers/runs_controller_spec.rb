  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved run as @run" do
        ...
        post :create, {:run => { "id" => "invalid value" }}, valid_session
        assigns(:run).should be_a_new(Run)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested run" do
        ...
        Run.any_instance.should_receive(:update_attributes).with({ "id" => "1" })
        put :update, {:id => run.to_param, :run => { "id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the run as @run" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Run.any_instance.stub(:save).and_return(false)
        put :update, {:id => run.to_param, :run => { "id" => "invalid value" }}, valid_session
        assigns(:run).should eq(run)
      end
